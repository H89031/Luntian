...
<head>
    ...
    <title>Luntian | Siotees Garden | Sampaguita (Jasminum sambac) flower</title>
    <style>
        body {
...
<body>
    ...
    <div class="top">
        <div class="pics">
            <img src="../images/Sampaguita.jpg" class="mainpic">
            <div class="smallpics">
                <img src="../images/Sampaguita.jpg" class="small">
                <img src="../images/Sampaguita.jpg" class="small">
                <img src="../images/Sampaguita.jpg" class="small">
            </div>
        </div>
        <div class="info">
            <h1>Sampaguita (Jasminum sambac) flower</h1>
            <div class="rating">
                <p>4.6</p>
            ...
            <div class="haha">
                ...
                <p><span style="font-weight: bold;">99</span> sold</p>
            </div>
            <div class="dits">
    ...
    <div class="mid">
        <div>
            ...
            <p>Once every 2-3 days (keep soil slightly moist)</p>
        </div>
        <div>
            <h2>Ideal Planting Conditions</h2>
            <p>Well-draining soil, prefers warm & humid climates</p>
        </div>
        <div>
        ...
        <div>
            <h2>Other Details</h2>
            <p>Sampaguita is the national flower of the Philippines, known for its fragrant white blossoms.</p>
            <p>It thrives outdoors and is often used for making garlands and perfumes.</p>
            <p>This low-maintenance flowering plant attracts butterflies and adds a refreshing floral scent to any garden</p>
        </div>
    </div>
    ...
    <div class="bottom">
        ...
        <div class="hehehe">
            ...
            <p style="color: grey;">Variation: Sampaguita<p>
            <p>Thank you po.<p>
            <div class="reviewpic">
                <img src="../images/SampaguitaRev.png">
                <img src="../images/SampaguitaRev.png">
                <img src="../images/SampaguitaRev.png">
            </div>
        </div>
    ...
    <div class="other">
        ...
        <div class="grid-item" onclick="window.location.href='product7.php';">

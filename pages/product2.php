...
<body>
    <div class="fixed-box">
        ...
        <div class="profile">
            ...
            <a href="profile.php?id=<?php echo $id; ?>" style="text-decoration-color: white;"><p style="margin: 0; font-size: 20px; color: white;">Username</p></a>
        </div>
        <p>
    </div>
    ...
    <div class="top">
        ...
        <div class="info">
            <h1>Aloe Vera Plant | Fully Rooted | Live Plant</h1>
            <div class="rating">
                <p>4.6</p>
            ...
            <div class="haha">
                ...
                <p><span style="font-weight: bold;">79</span> sold</p>
            </div>
            <div class="dits">
    ...
    <div class="mid">
        <div>
            ...
            <p>Bright, direct sunlight </p>
            <h2 style="margin-top: 20px;">Watering Schedule</h2>
            <p>Once every 2-3 weeks</p>
        </div>
        <div>
            <h2>Ideal Planting Conditions</h2>
            <p>Well-draining soil, prefers dry conditions</p>
        </div>
        <div>
        ...
        <div>
            <h2>Other Details</h2>
            <p>Aloe Vera is known for its medicinal and skin-care benefits.</p>
            <p>It thrives with minimal care and can be grown in pots or garden beds.</p>
        </div>
    </div>
    ...
    <div class="bottom">
        ...
        <div class="hehehe">
            ...
            <p style="color: grey;">Variation: Aloe Vera live rooted plant<p>
    ...
    <div class="other">
        <div class="grid-item" onclick="window.location.href='product11.php?id=<?php echo $id; ?>';">
            ...
            <p class="price">₱800</p>
            <p class="detail">64 sold | Novaliches, Quezon City</p>
        </div>

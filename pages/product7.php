...
<body>
    ...
    <div class="top">
        <div class="pics">
            <img src="../images/PalmTree.png" class="mainpic">
            <div class="smallpics">
                <img src="../images/PalmTree.png" class="small">
            </div>
        </div>
        <div class="info">
            <h1>Palmera Tree (Areca Palm) Indoor and Outdoor | Fully Rooted Live Plant 1.5ft</h1>
            <div class="rating">
                <p>4.6</p>
            ...
            <div class="haha">
                ...
                <p><span style="font-weight: bold;">200</span> sold</p>
            </div>
            <div class="dits">
    ...
    <div class="mid">
        <div>
            ...
            <p>Bright, indirect light (indoor) or partial to full sun (outdoor)</p>
            <h2 style="margin-top: 20px;">Watering Schedule</h2>
            <p>Once every 5-7 days (keep soil slightly moist but not soggy)</p>
        </div>
        <div>
            <h2>Ideal Planting Conditions</h2>
            <p>Well-draining, nutrient-rich soil with good aeration.</p>
        </div>
        <div>
            <h2>Common Pests & Diseases</h2>
            <p>Spider mites</p>
            <p>Mealybugs</p>
            <p>Fungal spots (if overwatered)</p>
        </div>
        <div>
            <h2>Other Details</h2>
    ...
    <div class="bottom">
        ...
        <div class="hehehe">
            ...
            <p style="color: grey;">Variation: Forget Me Nots<p>
            <p>Plant is as advertised. Currently healthy and thriving.<p>
            <div class="reviewpic">
                <img src="../images/PalmTreeRev.png">
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    function addtocart() {
        let product = {
            name: "Palmera Tree (Areca Palm) Indoor and Outdoor | Fully Rooted Live Plant 1.5ft",
            price: 199,
            image: "../images/PalmTree.png",
            quantity: 1
        };

...
<head>
    ...
    <title>Luntian | Siotees Garden | Calathea Triostar plant</title>
    <style>
        body {
...
<body>
    ...
    <div class="top">
        <div class="pics">
            <img src="../images/Calathea.png" class="mainpic">
            <div class="smallpics">
                <img src="../images/Calathea.png" class="small">
                <img src="../images/Calathea.png" class="small">
                <img src="../images/Calathea.png" class="small">
            </div>
        </div>
        <div class="info">
            <h1>Calathea Triostar plant</h1>
            <div class="rating">
                <p>4.6</p>
    ...
    <div class="mid">
        <div>
            ...
            <p>Low to medium, indirect light</p>
            <h2 style="margin-top: 20px;">Watering Schedule</h2>
            <p>Once every 5-7 days (keep soil moist but not soggy)</p>
        </div>
        <div>
            <h2>Ideal Planting Conditions</h2>
            <p>Moist, well-draining soil, prefers high humidity.</p>
        </div>
        <div>
        ...
        <div>
            <h2>Other Details</h2>
            <p>Calatheas, also known as Prayer Plants, are loved for their vibrant, patterned leaves that fold up at night as if in prayer.</p>
            <p>They are pet-friendly, excellent air purifiers, and thrive in indoor spaces with high humidity.</p>
            <p>Perfect for homes, offices, or indoor plant collections!</p>
        </div>
    </div>
    ...
    <div class="bottom">
        ...
        <div class="hehehe">
            ...
            <p style="color: grey;">Variation: Calathea Triostar<p>
            <p>Angaganda ng mga dahon...<p>
            <div class="reviewpic">
                <img src="../images/CalatheaRev.png">
                <img src="../images/CalatheaRev.png">
                <img src="../images/CalatheaRev.png">
            </div>
        </div>
    ...
    <div class="other">
        <div class="grid-item" onclick="window.location.href='product4.php';">
            ...
            <p class="price">₱129</p>
            <p class="detail">99 sold | Novaliches, Quezon City</p>
        </div>

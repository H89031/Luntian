...
<head>
    ...
    <title>Luntian | Siotees Garden | Outdoor Snake Plant</title>
    <style>
        body {
...
<body>
    ...
    <div class="top">
        <div class="pics">
            <img src="../images/SnakePlant.jpg" class="mainpic">
            <div class="smallpics">
                <img src="../images/SnakePlant.jpg" class="small">
                <img src="../images/SnakePlant.jpg" class="small">
                <img src="../images/SnakePlant.jpg" class="small">
            </div>
        </div>
        <div class="info">
            <h1>Outdoor Snake Plant (Dracaena trifasciata)</h1>
            <div class="rating">
                <p>4.7</p>
    ...
    <div class="mid">
        <div>
            ...
            <p>Once every 1-2 weeks (adjust based on climate)</p>
        </div>
        <div>
            <h2>Ideal Planting Conditions</h2>
            <p>Well-draining soil.</p>
            <p>Thrives in warm outdoor spaces.</p>
        </div>
        <div>
            <h2>Common Pests & Diseases</h2>
            <p>Mealybugs</p>
            <p>Fungal infections (if overwatered)</p>
        </div>
        <div>
            <h2>Other Details</h2>
            <p>Snake Plants are drought-tolerant and low-maintenance, making them ideal for outdoor gardens, patios, or balconies. </p>
            <p>They can withstand hot and dry conditions while adding a modern touch to any space!</p>
        </div>
    </div>
    ...
    <div class="bottom">
        ...
        <div class="hehehe">
            ...
            <p style="color: grey;">Variation: Snake Plant<p>
            <p>Wala ko masabi sa pagkaka balot secured na secured thanks a lot seller 🙏🤗 I will surely order again thanks<p>
            <div class="reviewpic">
                <img src="../images/SnakePlantRev.png">
                <img src="../images/SnakePlantRev.png">
                <img src="../images/SnakePlantRev.png">
            </div>
        </div>
    ...
    <div class="other">
        ...
        <div class="grid-item" onclick="window.location.href='product10.php?id=<?php echo $id; ?>';">
            ...
            <p class="price">₱800</p>
            <p class="detail">64 sold | Kaligayahan, Quezon City</p>
        </div>
    </div>
</body>
</html>

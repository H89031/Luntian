...
<body>
    ...
    <div class="top">
        <div class="pics">
            <img src="../images/Malvarosa.png" class="mainpic">
            <div class="smallpics">
                <img src="../images/Malvarosa.png" class="small">
            </div>
        </div>
        <div class="info">
            <h1>Malvarosa (Pelargonium graveolens) Anti-Mosquito</h1>
            <div class="rating">
                <p>4.6</p>
            ...
            <div class="haha">
                ...
                <p><span style="font-weight: bold;">274</span> sold</p>
            </div>
            <div class="dits">
    ...
    <div class="mid">
        <div>
            ...
            <p>Every 3-4 days (keep soil slightly moist but not soggy)</p>
        </div>
        <div>
            <h2>Ideal Planting Conditions</h2>
            <p>Well-draining, nutrient-rich soil with moderate moisture retention</p>
        </div>
        <div>
        ...
        <div>
            <h2>Other Details</h2>
            <p>The Malvarosa, also known as Scented Geranium, is a fragrant herb prized for its sweet, rose-like aroma and natural mosquito-repelling properties.</p>
            <p>This versatile plant is often used in essential oils, teas, and herbal remedies. It thrives in warm climates and can be grown in pots or garden beds.</p>
            <p>Low-maintenance and easy to care for, it’s a must-have for plant lovers and herbal enthusiasts!</p>
        </div>
    </div>
    ...
    <div class="bottom">
        ...
        <div class="hehehe">
            ...
            <p style="color: grey;">Variation: Malvarosa<p>
            <p>I received the plant in great condition. The seller packed it well.<p>
            <div class="reviewpic">
                <img src="../images/MalvarosaRev.png">
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    function addtocart() {
        let product = {
            name: "Malvarosa (Pelargonium graveolens) Anti-Mosquito",
            price: 129,
            image: "../images/Malvarosa.png",
            quantity: 1
        };
